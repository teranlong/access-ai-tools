...
This writes to:
```
agent-data/project-reports/access-migration-catalog/v1.1.0/{project-name}/files.json
agent-data/project-reports/access-migration-catalog/v1.1.0/{project-name}/chart-phase-count.png
agent-data/project-reports/access-migration-catalog/v1.1.0/{project-name}/chart-capability-pie.png
agent-data/project-reports/access-migration-catalog/v1.1.0/{project-name}/chart-extension-bar.png
agent-data/project-reports/access-migration-catalog/v1.1.0/{project-name}/chart-size-map.png
```
...
Write the report to:
```
agent-data/project-reports/access-migration-catalog/v1.1.0/{project-name}/catalog-report.md
```
...
After writing the report, open it with the system default application:

```bash
start "" "agent-data/project-reports/access-migration-catalog/v1.1.0/{project-name}/catalog-report.md"
```
